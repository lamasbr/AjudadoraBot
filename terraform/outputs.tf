...
output "app_service_image" {
  description = "Pinned container image used by the App Service"
  value       = "${var.container_registry}/${var.app_name}:${var.app_version}"
}
...
output "telegram_webhook_url" {
  ...
  value       = "https://${module.app.default_hostname}/webhook"
}

# Health Check URL
output "health_check_url" {
  description = "Health check endpoint URL"
  value       = "https://${module.app.default_hostname}/health"
}

# API Documentation URL
output "swagger_url" {
  description = "Swagger API documentation URL (if enabled)"
  value       = "https://${module.app.default_hostname}/swagger"
}
...
output "datadog_config" {
  ...
  value = {
    api_key_secret = "datadog-api-key" # Secret name in Key Vault
...
output "security_config" {
  ...
  value = {
    ...
    ftps_disabled            = true
    system_assigned_identity = module.app.principal_id
  }
}